	...
	return (
		<div className="product-details container">
			<div className="back">
				...
				{!isLoading && product && (
					<>
						{product.categories.some((category) => category.name === 'Bicycles') ? (
							<Link
								to={'/shop/bicycles'}
								style={{ color: '#a8a8a8', textDecoration: 'none' }}
							>
								<span className="product-header">Bicycles</span>
							</Link>
						) : (
							<Link
								to={'/shop/accessories'}
								style={{ color: '#a8a8a8', textDecoration: 'none' }}
							>
								<span className="product-header">Accessories</span>
							</Link>
						)}
